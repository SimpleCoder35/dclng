...
import srsly
import torch
from colpali_engine.models import ColPali, ColPaliProcessor, ColQwen2, ColQwen2Processor, ColQwen2_5, ColQwen2_5Processor
from pdf2image import convert_from_path
from PIL import Image

from byaldi_extended.objects import Result
from byaldi_extended._version import __version__ as VERSION
...
class ColPaliModel:
    def __init__(
        ...
        index_root: str = ".byaldi_extended",
        ...
        **kwargs,
        ...
        if (
            ...
            raise ValueError(
                "This extended version of Byaldi only supports ColPali, ColQwen2 and ColQwen2_5 for now. Incorrect model name specified."
            )
        ...
        if "colpali" in pretrained_model_name_or_path.lower():
            ...
            self.processor = cast(
                ColQwen2_5Processor,
                ColQwen2_5Processor.from_pretrained(
                    self.pretrained_model_name_or_path,
                    token=kwargs.get("hf_token", None) or os.environ.get("HF_TOKEN"),
                ),
            )
